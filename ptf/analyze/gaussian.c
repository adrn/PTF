...
/* Define docstrings */
static char module_docstring[] = "Fast gaussian integration";
...
{
    PyObject *m;
    MOD_DEF(m, "gaussian", module_docstring, module_methods);
    if (m == NULL)
...
static PyObject *gaussian_error_func(PyObject *self, PyObject *args)
{
    ...
    double p0, p1, p2, p3;
    PyObject *x_obj, *y_obj, *e_obj;

    /* Parse the input tuple */
    if (!PyArg_ParseTuple(args, "ddddOOO", &p0, &p1, &p2, &p3, &x_obj, &y_obj, &e_obj))
        return NULL;
