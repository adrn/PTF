...
static char microlensing_docstring[] = "Point-source, point-lens microlensing function";
...
static PyObject *microlensing_error_func(PyObject *self, PyObject *args);
...
static PyMethodDef module_methods[] = {
    ...
    {"microlensing_error_func", microlensing_error_func, METH_VARARGS, linear_docstring},
    {NULL, NULL, 0, NULL}
};
...
static PyObject *microlensing_error_func(PyObject *self, PyObject *args)
{
    ...
    // p0 = u0, p1 = t0, p2 = tE, p3 = m0
    for(i = 0; i < n; i++) {
        d = (x[i] - p1) / p2;
        u = sqrt(p0*p0 + d*d);
        A = (u*u + 2) / (u*sqrt(u*u + 4));
        m_ti = p3 - 2.5*log10(A);
        r[i] = (y[i] - m_ti) / e[i];
    }
