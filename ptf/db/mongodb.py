...
from ..analyze import compute_variability_indices, fit_microlensing_event
...
def light_curve_to_document(light_curve, **kwargs):
    ...
    """
    document = dict()
    document["indices"] = kwargs.get("indices", compute_variability_indices(light_curve, indices=["eta", "j", "k", "delta_chi_squared", "sigma_mu"]))
    document["microlensing_fit"] = kwargs.get("microlensing_fit", fit_microlensing_event(light_curve))
    document["features"] = kwargs.get("features", None)
