...
\author{Adrian~M.~Price-Whelan\altaffilmark{\ref{col}}, Marcel~A.~Ag\"ueros\altaffilmark{\ref{col}}, Amanda Fournier\altaffilmark{\ref{ucsb}}, Rachel Street\altaffilmark{\ref{lcogt}}, Eran Ofek\altaffilmark{\ref{weiz},\ref{eins}}, David Levitan\altaffilmark{\ref{calt}}, and the PTF Collaboration}
...
Over the past 20 years, microlensing, in which gravitational lensing results in a transient increase in flux from a background source, has been applied to the search for dark and compact objects \citep{original_macho, oslowski2008, sartore2010}, to study Galactic structure and kinematics \citep{binney2000}, and, most recently. to identify extrasolar planets \citep{gaudi2011}. Such studies were once limited by the small number of detected events, but with advances in CCD technology and the development dedicated microlensing surveys \citep{original_ogle, original_macho, eros_original}, more than 1000 events are now detected each year. In the next decade, this number is expected to rise as the next generation of photometric, time-domain surveys come online, providing an opportunity for the precise study of otherwise hard-to-characterize objects such as low-mass stars and substellar objects, and stellar remnants such as isolated neutron stars. 
